import{x as s}from"./iframe-ybnrdH9j.js";import"./dx-input-select-DXFeTbEf.js";import"./preload-helper-C1FmrZbK.js";import"./dx-ac-base-element-C-d1-0EW.js";import"./state-Bh1Vt1B2.js";import"./lodash-CR4q0RmQ.js";import"./dx-list-item-CCuzrOBD.js";import"./cssClassEnums-ChRP0d8n.js";import"./dx-button-CfBPH_tj.js";import"./localization-BgXZqBVD.js";import"./dx-input-select-DRXt9p_b.js";import"./index-DCOgErna.js";import"./index-B5ETzRfW.js";import"./keyboardEventKeys-BnoN8uA3.js";const V={title:"Input/dx-input-select",tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the select input.",table:{defaultValue:{summary:""}}},disabled:{control:"boolean",description:"If true, disables the select input.",table:{defaultValue:{summary:"false"}}},selectedValue:{control:"text",description:"The selected value.",table:{defaultValue:{summary:""}}},placeholder:{control:"text",description:"The placeholder text for the select input.",table:{defaultValue:{summary:""}}},alwaysShowPlaceholder:{control:"boolean",description:"If true, always show the placeholder.",table:{defaultValue:{summary:"false"}}},options:{control:"object",description:"The select options as an array of OptionData or strings.",table:{defaultValue:{summary:"[]"}}}},args:{label:"Select an option",disabled:!1,selectedValue:"",placeholder:"Choose...",alwaysShowPlaceholder:!1,options:[{id:"1",name:"Option 1",value:"1"},{id:"2",name:"Option 2",value:"2"},{id:"3",name:"Option 3",value:"3"}]},render:e=>s`
    <dx-input-select
      label="${e.label}"
      ?disabled=${e.disabled}
