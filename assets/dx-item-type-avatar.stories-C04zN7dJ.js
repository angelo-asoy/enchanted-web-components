import{x as n}from"./iframe-C-Uqj5Hx.js";import{I as e}from"./dx-item-type-avatar-DSDeBIr_.js";import"./preload-helper-C1FmrZbK.js";import"./dx-ac-base-element-DwoanvIH.js";import"./dx-avatar-DS6BnUN1.js";import"./cssClassEnums-DKCjOuJT.js";import"./index-DcRqLC2p.js";import"./exportParts-pu2Pj9Yh.js";const P={title:"Data Display/dx-item-type-avatar",tags:["autodocs"],argTypes:{itemType:{control:{type:"select"},options:Object.values(e),description:"The type of the item (icon type).",table:{defaultValue:{summary:""}}},imageUrl:{control:"text",description:"The image URL for the avatar.",table:{defaultValue:{summary:""}}}},args:{itemType:e.APPLICATION,imageUrl:""},render:y=>n`
    <dx-item-type-avatar
      .itemType=${y.itemType}
    ></dx-item-type-avatar>
  `},t={},a={render:()=>n`
