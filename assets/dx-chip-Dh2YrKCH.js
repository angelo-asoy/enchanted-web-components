import{n as o,t as u,D as d,L as I}from"./dx-ac-base-element-C-d1-0EW.js";import{E as C,x as p}from"./iframe-ybnrdH9j.js";import{C as a}from"./cssClassEnums-ChRP0d8n.js";import{g as _}from"./localization-BgXZqBVD.js";var f=Object.defineProperty,m=Object.getOwnPropertyDescriptor,r=(s,i,c,n)=>{for(var e=n>1?void 0:n?m(i,c):i,l=s.length-1,h;l>=0;l--)(h=s[l])&&(e=(n?h(i,c,e):h(e))||e);return n&&e&&f(i,c,e),e};let t=class extends d{constructor(){super(...arguments),this.name="",this.count=0,this.showChipCount=!1,this.showAvatar=!1,this.clearIcon=!1,this.disabled=!1}isLocaleRTL(){return _()===I.RTL}render(){const s=this.isLocaleRTL()?a.CHIP_COUNT_RTL:a.CHIP_COUNT;return p`
