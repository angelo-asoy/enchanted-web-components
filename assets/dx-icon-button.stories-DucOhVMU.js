import{x as i}from"./iframe-ybnrdH9j.js";import"./dx-icon-button-D9Pmlgbk.js";import{I as n}from"./cssClassEnums-ChRP0d8n.js";import{s as t}from"./svg-search-BYjp6e-l.js";import"./preload-helper-C1FmrZbK.js";import"./dx-ac-base-element-C-d1-0EW.js";import"./dx-button-CfBPH_tj.js";import"./state-Bh1Vt1B2.js";import"./localization-BgXZqBVD.js";import"./exportParts-BXxV9uDV.js";const f={title:"Input/dx-icon-button",tags:["autodocs"],argTypes:{size:{control:{type:"select"},options:["SMALL","MEDIUM","LARGE"],description:"The size of the icon button.",table:{defaultValue:{summary:"SMALL"}}},withPadding:{control:"boolean",description:"If true, adds padding to the button.",table:{defaultValue:{summary:"false"}}},imgurl:{control:"text",description:"The image URL for the icon.",table:{defaultValue:{summary:""}}},disabled:{control:"boolean",description:"If true, disables the button.",table:{defaultValue:{summary:"false"}}},inverseColor:{control:"boolean",description:"If true, uses the inverse color scheme.",table:{defaultValue:{summary:"false"}}}},args:{size:n.SMALL,withPadding:!1,imgurl:"https://cdn-icons-png.flaticon.com/512/61/61456.png",disabled:!1,inverseColor:!1},render:o=>i`
    <dx-icon-button
      size="${o.size}"
